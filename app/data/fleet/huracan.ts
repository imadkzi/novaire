...
export const huracan = buildVehicle(FOLDER, {
  ...
  name: 'Huracán · Verde Shock',
  marque: 'Lamborghini',
  category: 'self-drive',
  tagline: 'Verde shock, theatre, and a V10 that won’t whisper',
  description:
    'Lamborghini Huracán in signature Verde Shock, self-drive hire for music videos, nightlife, and content that must read in a single scroll.',
  intro:
